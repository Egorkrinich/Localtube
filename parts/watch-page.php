                ...
                <div class="control__body">
                    ...
                    <div class="control__container f-row-between"> 
                        ...
                        <div class="control__left f-row">
                            <button class="player__btn toggle-btn" 
                            data-player-btn="toggle-play">
                                <svg class="toggle__item toggle__item--inactive" width="30px" height="30px"viewBox="0 0 36 36">
                                ...
                                <svg class="toggle__item toggle__item--active" width="30px" height="30px" viewBox="0 0 36 36">
                            ...
                            <button class="player__btn toggle-btn" 
                            data-player-btn="toggle-sound">
                                <svg class="toggle__item toggle__item--inactive" width="30px" height="30px" viewBox="0 -960 960 960">
                                ...
                                <svg class="toggle__item toggle__item--active" width="30px" height="30px" viewBox="0 -960 960 960">
